                        ...
                        <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-6">
                            <ul className="space-y-4 m-0 list-none pl-0">
                                <li className="flex gap-4">
                                    ...
                                    <span className="text-gray-600 dark:text-gray-400">Which specific page URL you viewed (e.g., /pdf-editor).</span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="font-semibold min-w-[140px]">Timestamp:</span>
                                    <span className="text-gray-600 dark:text-gray-400">The exact date and time of your visit.</span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="font-semibold min-w-[140px]">Referrer:</span>
                                    <span className="text-gray-600 dark:text-gray-400">The website that linked you here (e.g., Google, Twitter, or Direct).</span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="font-semibold min-w-[140px]">Device Type:</span>
                                    <span className="text-gray-600 dark:text-gray-400">Whether you are using a Mobile, Tablet, or Desktop device.</span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="font-semibold min-w-[140px]">Screen Size:</span>
                                    <span className="text-gray-600 dark:text-gray-400">Your screen resolution (e.g., 1920x1080) to help check design responsiveness.</span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="font-semibold min-w-[140px]">Language:</span>
                                    <span className="text-gray-600 dark:text-gray-400">Your browser's preferred language setting (e.g., en-US).</span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="font-semibold min-w-[140px]">Timezone:</span>
                                    <span className="text-gray-600 dark:text-gray-400">Your local timezone (e.g., Asia/Kolkata).</span>
                                </li>
                            </ul>
                        </div>
                    </section>
