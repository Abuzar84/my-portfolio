...
export default function AdminPage() {
        ...
        return (
            <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-100 flex items-center justify-center">
                <div className="text-center space-y-4">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-indigo-100 dark:bg-indigo-900/30 animate-pulse">
    ...
    if (!user) {
        return (
            <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-100 flex items-center justify-center px-4">
                ...
                <div className="max-w-md w-full space-y-8">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Sign in to access analytics</p>
                    </div>

                    <form onSubmit={handleLogin} className="space-y-4">
                        {error && (
                            <div className="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/30 text-red-600 dark:text-red-400 text-sm">
                                {error}
                            </div>
                        )}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-300 dark:border-white/10 bg-white dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        ...
                        <button
                            ...
                            className="w-full px-6 py-3 rounded-xl bg-black dark:bg-white text-white dark:text-black font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <Link
                        href="/"
                        className="flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors"
                    >
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-gray-100">
            ...
            {/* Header */}
            <header className="bg-white dark:bg-zinc-950 border-b border-gray-200 dark:border-white/10 sticky top-0 z-40">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 text-sm rounded-lg border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
                            >
            ...
            <main className="max-w-7xl mx-auto px-4 py-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                    ...
                    <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                        ...
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">Recent Views</h3>
                    ...
                    <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                        ...
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">Pages Tracked</h3>
                    ...
                    <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                        ...
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">Top Referrers</h3>
                                        ...
                                        return (
                                            <div key={page} className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                    ...
                                                    <span className="text-gray-600 dark:text-gray-400">{count} views</span>
                                                </div>
                        ...
                        <div className="space-y-3">
                            {topReferrers.length > 0 ? (
                                topReferrers.map((ref, idx) => (
                                    <div
                                        key={idx}
                                        className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5"
                                    >
                                ...
                                <p className="text-gray-500 dark:text-gray-400 text-center py-8">No referrer data</p>
                            )}
                        </div>
                    </div>
                </div>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-200 dark:border-white/10">
                                    ...
                                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600 dark:text-gray-400">Referrer</th>
                                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600 dark:text-gray-400">Device</th>
                                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600 dark:text-gray-400">Location</th>
                                </tr>
                            </thead>
                            <tbody>
